...
import com.spurtreetech.sttarter.lib.helper.models.Group_MembersArray;
...
public class GroupMembersListActivity extends AppCompatActivity {
    ...
    Group_MembersArray group_membersArray;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Group_user_data[] group_membersArrays = gson.fromJson(getIntent().getExtras().getString("TOPIC_GROUP"),Group_user_data[].class);
