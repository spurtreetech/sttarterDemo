package com.mobile.android.sttarterdemo.gcm;
...
public class GCMClientManager {
    ...
    public GCMClientManager(Activity activity, String projectNumber) {
        ...
        sp = activity.getSharedPreferences(Constants.DEFAULT_PREF, Context.MODE_PRIVATE);
    }
    ...
    private String getRegistrationId(Context context) {
        String registrationId = sp.getString(Constants.DEVICE_ID, "");
    ...
    private void storeRegistrationId(Context context, String regId) {
        ...
        sp.edit().putString(Constants.DEVICE_ID, regId).commit();
